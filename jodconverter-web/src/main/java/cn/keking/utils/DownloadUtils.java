...
public class DownloadUtils {
    ...
    private final String prefix = ConfigConstants.getDownloadPrefix();
    ...
    public ReturnResponse<String> downLoad(FileAttribute fileAttribute, String fileName) {
        ...
        try {
            ...
            if (url.getProtocol() != null && (url.getProtocol().toLowerCase().startsWith("file")
                    || url.getProtocol().toLowerCase().startsWith("http"))) {
                ...
                String ftpControlEncoding = fileUtils.getUrlParameterReg(fileAttribute.getUrl(),
